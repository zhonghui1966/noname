const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["_virtual/index.js","_virtual/_commonjsHelpers.js","node_modules/.pnpm/core-js-bundle@3.45.1/node_modules/core-js-bundle/index.js","_virtual/index2.js"])))=>i.map(i=>d[i]);
...
(async function() {
  await __vitePreload(() => import("../_virtual/index.js").then((n) => n.i), true ? __vite__mapDeps([0,1,2,3]) : void 0);
  const globalText = {
  ...
  await __vitePreload(() => import("../jit/index.js"), true ? [] : void 0);
  try {
    await boot();
