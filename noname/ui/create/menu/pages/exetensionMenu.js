          ...
          for (var i in dash4.content) {
            try {
              if (["arenaReady", "content", "prepare", "precontent"].includes(i)) {
                ext[i] = exports.exec2(`return (${dash4.content[i]});`).return;
                ...
                ext[i] = exports.exec2(dash4.content[i])[i];
	...
	return ${str} 
      ...
      var dash2 = (function() {
        ...
        var saveInput = function(view) {
          ...
          try {
            var { card } = exports.exec2(inputCode);
...
`;
        ...
        var saveInput = function(view) {
          ...
          try {
            var { skill } = exports.exec2(resultCode);
          ...
          var saveInput = function(view) {
            ...
            try {
              if (["arenaReady", "content", "prepare", "precontent"].includes(link)) {
                var { func: func2 } = exports.exec2(`func = ${resultCode}`);
                if (typeof func2 != "function") {
                  throw "err";
                }
              } else if (link == "config") {
                var { config } = exports.exec2(resultCode);
                if (config == null || typeof config != "object") {
                  throw "err";
                }
              } else if (link == "help") {
                var { help } = exports.exec2(resultCode);
  ...
  (function() {
    ...
    node._initLink = function() {
      ...
      node.update = function() {
        ...
        }).then((response) => response.text()).then(exports.eval).then(loaded).catch((reason) => {
          console.log(reason);
          delete window.extension;
