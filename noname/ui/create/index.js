...
class Create {
  ...
  async editor2(container, config = {}) {
    ...
    const { EditorView } = await __vitePreload(async () => {
      const { EditorView: EditorView2 } = await import("../../../node_modules/.pnpm/@codemirror_view@6.38.3/node_modules/@codemirror/view/dist/index.js");
      return { EditorView: EditorView2 };
    }, true ? __vite__mapDeps([1,2,3,4,5,6]) : void 0);
    const { linter, lintGutter } = await __vitePreload(async () => {
      const { linter: linter2, lintGutter: lintGutter2 } = await import("../../../node_modules/.pnpm/@codemirror_lint@6.8.5/node_modules/@codemirror/lint/dist/index.js");
    ...
    if (language === "javascript" || language === "typescript") {
      ...
      if (language === "javascript") {
        const { Linter } = await __vitePreload(async () => {
          const { Linter: Linter2 } = await import("../../../node_modules/.pnpm/eslint-linter-browserify@9.36.0/node_modules/eslint-linter-browserify/linter.js");
      ...
      const { css } = await __vitePreload(async () => {
        ...
        return { css: css2 };
      }, true ? __vite__mapDeps([96,97,16,8,9,7,2,3,1,4,5,6]) : void 0);
      extensions.push(css());
      ...
      }, true ? __vite__mapDeps([98,99,16,8,9,7,2,3,1,4,5,6]) : void 0);
      extensions.push(json(), linter(jsonParseLinter()));
    } else if (language === "html") {
      const { html } = await __vitePreload(async () => {
        const { html: html2 } = await import("../../../node_modules/.pnpm/@codemirror_lang-html@6.4.10/node_modules/@codemirror/lang-html/dist/index.js");
        return { html: html2 };
      }, true ? __vite__mapDeps([100,101,16,8,9,96,97,7,2,3,1,4,5,6,14,15,12]) : void 0);
      const { parser: htmlParser } = await __vitePreload(async () => {
        const { parser: htmlParser2 } = await import("../../../node_modules/.pnpm/@lezer_html@1.3.10/node_modules/@lezer/html/dist/index.js");
        return { parser: htmlParser2 };
      }, true ? __vite__mapDeps([101,16,8,9]) : void 0);
      ...
      const { parseMixed } = await __vitePreload(async () => {
        const { parseMixed: parseMixed2 } = await import("../../../node_modules/.pnpm/@lezer_common@1.2.3/node_modules/@lezer/common/dist/index.js");
      ...
      const { markdown } = await __vitePreload(async () => {
        const { markdown: markdown2 } = await import("../../../node_modules/.pnpm/@codemirror_lang-markdown@6.3.4/node_modules/@codemirror/lang-markdown/dist/index.js");
        return { markdown: markdown2 };
      }, true ? __vite__mapDeps([102,2,3,1,4,5,6,7,8,9,12,103,100,101,16,96,97,14,15]) : void 0);
      ...
      const { vue } = await __vitePreload(async () => {
        ...
        return { vue: vue2 };
      }, true ? __vite__mapDeps([104,7,8,2,3,1,4,5,6,9,100,101,16,96,97,14,15,12]) : void 0);
      extensions.push(vue());
    }
  ...
  arena() {
    ...
    if (lib.config.keep_awake) {
      if (window.plugins && window.plugins.insomnia) {
        ...
        __vitePreload(async () => {
          const { default: NoSleep } = await import("../../../_virtual/index7.js").then((n) => n.i);
          return { default: NoSleep };
        }, true ? __vite__mapDeps([105,20,106,107]) : void 0).then(function({ default: NoSleep }) {
